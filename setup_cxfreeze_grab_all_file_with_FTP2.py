...
#run with : python setup_cxfreeze_grab_all_file_with_FTP2.py build
#OR
...
setup(  name = "grab_all_file_with_FTP2_V1",
        version = "1.0",
        description = "luc!",
        options = {"build_exe": build_exe_options},
        executables = [Executable("grab_all_file_with_FTP2.py", base=base)])
