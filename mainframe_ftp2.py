...
def select_level_2_3(file_list):  
    ...
    listbox1 = tk.Listbox(master2, listvariable=file_list, width=15, height = 20)
    listbox1.grid(column=0, row=2, rowspan=15, sticky=("n", "w", "e", "s"))
    listbox1.focus()
      
    btn1 = tk.Button(master2, text="Submit", bg="white", fg="green",  height = 2, width = 10, command=clicked_List_Submit)
    btn1.grid(column=2, row=4, sticky="e", padx=50, pady=50)
    
    listbox1.bind('<Double-1>', lambda x: btn1.invoke())
